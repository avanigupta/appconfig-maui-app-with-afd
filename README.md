...
- Azure Front Door instance configured for your App Configuration. Follow instructions at `https://aka.ms/appconfig/azurefrontdoor`
...
1. Configure your App Configuration store to expose the required key-values through Azure Front Door. Follow instructions at `https://aka.ms/appconfig/azurefrontdoor`.
